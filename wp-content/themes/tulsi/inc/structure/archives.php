...
if ( ! function_exists( 'tulsi_archive_title' ) ) {
	add_action( 'tulsi_archive_title', 'tulsi_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function tulsi_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * tulsi_before_archive_title hook.
			 *
			 */
			do_action( 'tulsi_before_archive_title' );
			?>
			...
			<?php
			/**
			 * tulsi_after_archive_title hook.
			 *
			 */
			do_action( 'tulsi_after_archive_title' );
			...
			/**
			 * tulsi_after_archive_description hook.
			 *
			 */
			do_action( 'tulsi_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'tulsi_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'tulsi_filter_the_archive_title' );
	/**
	 ...
	 */
	function tulsi_filter_the_archive_title( $title ) {
		if ( is_category() ) {
