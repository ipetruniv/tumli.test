...
if ( ! function_exists( 'tulsi_social_bar' ) ) {
	add_action( 'tulsi_social_bar_action', 'tulsi_social_bar' );
	function tulsi_social_bar() {
		$socials_facebook_url  		=  tulsi_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  tulsi_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  tulsi_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  tulsi_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  tulsi_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  tulsi_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  tulsi_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  tulsi_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  tulsi_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  tulsi_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  tulsi_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  tulsi_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  tulsi_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  tulsi_get_setting( 'socials_mail_url' );
	?>
