...
$navigation_active = ( 'nav-right-sidebar' == tulsi_get_navigation_location() ) ? true : false;
...
?>
<div id="right-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php tulsi_right_sidebar_class(); ?>>
	<div class="inside-right-sidebar">
		<?php
		/**
		 * tulsi_before_right_sidebar_content hook.
		 *
		 */
		do_action( 'tulsi_before_right_sidebar_content' );
		...
		/**
		 * tulsi_after_right_sidebar_content hook.
		 *
		 */
		do_action( 'tulsi_after_right_sidebar_content' );
		?>
